...
- [ ] `15faafc6b449` sched,init: Fix DEBUG_PREEMPT vs early boot — [`15faafc6_init_fix_debug_preempt_vs.md`](bugs/15faafc6_init_fix_debug_preempt_vs.md)
...
- [ ] `771fac5e26c1` Revert "cpufreq: CPPC: Add support for frequency invariance" — [`771fac5e_cpufreq_cppc_add_support_for.md`](bugs/771fac5e_cpufreq_cppc_add_support_for.md)
...
- [ ] `b5c4477366fb` sched: Use cpu_dying() to fix balance_push vs hotplug-rollback — [`b5c44773_use_cpu_dying_to_fix.md`](bugs/b5c44773_use_cpu_dying_to_fix.md)
