...
- [x] `d136122f5845` sched: Fix race against ptrace_freeze_trace() — [`d136122f_fix_race_ptrace_freeze.md`](bugs/d136122f_fix_race_ptrace_freeze.md) <!-- driver:ptrace_freeze attempts:2 -->
...
- [-] `e65855a52b47` Fix a deadlock when enabling uclamp static key — [`e65855a5_fix_deadlock_enabling_uclamp_static.md`](bugs/e65855a5_fix_deadlock_enabling_uclamp_static.md) <!-- skipped:v5.8-rc6 kernel has SLUB/objtool build issues with current toolchain; sched_setattr_nocheck deadlocks confirming bug but cannot get clean output attempts:1 -->
